    ...
    public partial class ManageCategory : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlStatement = "INSERT INTO shopritedb.productcattable( CatId, CatName, CatDesc) VALUES ('" +this.CatId.Text+"','" + this.Catname.Text + "','" + this.Catdesc.Text + "');";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Con.Open();
                    string query = "delete from productcattable where CatId=" + CatId.Text + "";
