    ...
    public partial class SellingForm : Form
    {
       ...
       private void FillCombo()
        ...
        private void populatebill()
        {
            ...
            Con.Open();
            string query = "select * from shopritedb.billtb";
            MySqlDataAdapter sda = new MySqlDataAdapter(query, Con);
            MySqlCommandBuilder builder = new MySqlCommandBuilder(sda);
        ...
        private void button1_Click(object sender , EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    //string sqlStatement = $"INSERT INTO `productcattable`( `CatId`, `CatName`, `CatDesc`) VALUES ('{this.CatId.Text}','{this.Catname.Text}','{this.Catdesc.Text}')";
                    string sqlStatement = "INSERT INTO shopritedb.billtb VALUES ('" + this.BILLID.Text + "','" + this.Seller1.Text + "','" + this.date1.Text + "', '" + this.GrdTotal + "');";
