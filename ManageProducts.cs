       ...
       /* private void FillCombo1()
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlStatement = "INSERT INTO shopritedb.producttable( ProdId, ProdName, ProdQty, ProdPrice, ProdCat) VALUES ('" + this.ProdId.Text + "','" + this.Prodname.Text + "','" + this.Prodqty.Text + "', '"+ this.ProdPrice.Text + "','"+ this.ProdCatcombo.Text+ "' );";
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Con.Open();
                    string query = "update producttable set  ProdName='" + Prodname.Text+"', ProdQty='" + Prodqty.Text + "', ProdPrice ='" + ProdPrice.Text + "', ProdCat='" + ProdCatcombo.Text+"', where ProdId=" + ProdId.Text + ";";
